<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    <%@include file="../../path.jsp"%>
        ...
        <head>
            ...
            <script src="${path}/vendor/jquery/jquery.form.js"></script>
            <title>预约</title>
            <style type="text/css">
            .province {
            ...
            <div class="weui-cells weui-cells_form">
                <div class="weui-cell">
                    <div class="weui-cell__hd">
                        <a class="province open-popup" id="province_input" data-target="#province_popup">粤</a>
                        <a class="city open-popup" id="city_input" data-target="#city_popup">A</a>
                    </div>
