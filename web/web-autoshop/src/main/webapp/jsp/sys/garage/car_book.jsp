...
<head>
    ...
    <script type="text/javascript" src="${path}/js/jquery/jquery-3.2.1.js" charset="UTF-8"></script>
    <script type="text/javascript" src="${path}/js/jquery/jquery.form.js" charset="UTF-8"></script>
    <script type="text/javascript" src="${path}/lib/layer/layer.js" charset="utf-8"></script>
    <script type="text/javascript" src="${path}/js/kuding/garage/plate_number.js" charset="utf-8"></script>
